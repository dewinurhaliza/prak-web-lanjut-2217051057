...
<style>
    ...
    select {
        background-color: #f8f9fa; /* Mengganti warna putih dengan warna abu-abu muda */
        color: #000000; /* Atur teks select menjadi hitam */
    }

    .form-buttons {
        display: flex;
        justify-content: space-between; /* Menjaga jarak tombol agar berada di ujung yang berbeda */
    }
